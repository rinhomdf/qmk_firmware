...
// Need to hold down RAISE and LOWER to access the each layer
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |  ` ~ |   z  |   x  |   c  |   v  |   b  |                             |   n  |   m  |   ,  |   .  | / ?  | \    |
     * +------+------+------+------+-------------+                             +-------------+------+------+------+------+
     * | HOME | END  |L_ARR | D_ARR|                                                         |UP_ARR|DW_ARR|   [  |  ]   |
     * +------+------+-------------+-------------+                             +-------------+-------------+------+------+
     *                             |    SPACE    |                             |   BCKSPC    |
     *                             |-------------|                             |-------------|
     *                             |    SHIFT    |                             |    ENTER    |
    ...
    [_LOWER] = LAYOUT(
        _______, QK_BOOT, _______, KC_UP,   _______, KC_LBRC,             KC_RBRC, _______, KC_NUM,  KC_INS,  KC_SCRL, KC_MUTE,
